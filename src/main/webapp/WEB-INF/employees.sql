...
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values (1,'희진','김','1','1',to_date('23/05/16','RR/MM/DD'),'AC_ACCOUNT',1,0.1,1,10);
--------------------------------------------------------
